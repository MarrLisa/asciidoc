...
ifdef::g_fa_2[]
{sing_doc}, как на <<id_image-g_fa_2, Рисунке {counter:figure-number}>>.

[[id_image-g_fa_2]]
.Рисунок {counter:figure-number}. Модальное окно «Направление документа на согласование»
image::g_fa_2.png[{image-size2}, align="center"]
endif::g_fa_2[]

ifndef::g_fa_2[]
:g_fa_2:
{sing_doc}, как на <<id_image-g_fa_2.1, Рисунке {counter:figure-number}>>.
...
image::g_fa_3.png[{image-size2}, align="center"]
endif::[]

ifndef::g_fa_3[]
:g_fa_3:
Далее система автоматически подберет актуальный сертификат, и в его карточке необходимо нажать кнопку «Создать подпись», как на <<id_image-g_fa_3.1, Рисунке {counter:figure-number}>>.
...
image::g_fa_4.png[{image-size2}, align="center"]
endif::[]
...
ifdef::g_fa_5[]
:g_fa_5.1:
По нажатию можно скачать печатную форму с отображением информации: «Документ подписан электронной подписью», Номер сертификата, Владелец, Действителен: с дд.мм.гггг по дд.мм.гггг, как на <<id_image-g_fa_5, Рисунке {counter:figure-number}>>.

[[id_image-g_fa_5]]
.Рисунок {counter:figure-number}. Печатная форма заявки с отображением подписи
image::g_fa_5.png[{image-size2}, align="center"]
endif::[]
...
ifdef::g_fa_6[]
:g_fa_6.1:
Если данные не совпадают, отобразится модальное окно с указанием на ошибку, как на <<id_image-g_fa_6, Рисунке {counter:figure-number}>>.
