...
class PDFConverterWithFullPageBorder < (Asciidoctor::Converter.for 'pdf')
  ...
  def draw_full_page_border
    ...
    canvas do
      ...
      stroke_rectangle [my_left_x, page_height-my_left_y], page_width-my_rigth_x, page_height-my_rigth_y      
      
      # Рисуем внешнижний прямоугольник от верхнего левого угла до нижнего правого
      stroke_rectangle [my_left_x, my_left_x+10], page_width-my_rigth_x, my_left_x-4
      
      # Рисуем прямоугольник Для ЛИСТ и его число
      stroke_rectangle [my_left_x +495, my_left_x+10], page_width-my_rigth_x -495, my_left_x-4

            # Рисуем прямоугольник Для ЛИСТ маленький
      stroke_rectangle [my_left_x +495, my_left_x+10], page_width-my_rigth_x -495, my_left_x-4 -20


      # stroke_rectangle [25, 100], page_width-20, 20
    end
  end
end
